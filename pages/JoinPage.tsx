...
function JoinPage() {
  return (
    <div className=' hello text-white  flex items-center justify-center cursor-context-menu pt-9 lg:py-1' >
      ...
      <form action="" className='text-start bg-transparent lg:px-9 px-5 border rounded-lg py-2  lg:py-3 text-xl lg:text-sm w-screen lg:w-auto h-5/6 lg:h-auto' style={{ backgroundImage: "url('/images/Colored\ Shapes.svg')" }}>
        ...
        <input type="number" minLength={16} min={0}  required placeholder='Enter valid National ID' id='id' className=" number mt-1 mb-3 w-full px-6 py-3 rounded-md outline-none lg:mt-1 lg:mb-3 lg:w-96 lg:text-md lg:px-3 lg:py-1.5 text-gray-700 placeholder:text-indigo-600 placeholder:italic placeholder:font-bold"/><br />
